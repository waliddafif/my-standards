...
> Ce fichier (`GEMINI.md`) doit rester aligné. En cas de conflit, **`CLAUDE.md` fait foi**.

Instructions pour Google Gemini CLI et Gemini Code Assist.
...
- **Ne pas modifier `CLAUDE.md`** sans mettre à jour `GEMINI.md` en conséquence
- **Ne pas dupliquer** les règles entre `CLAUDE.md` et `GEMINI.md`
